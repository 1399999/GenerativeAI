...
namespace OpenCVUtilities
{
	...
	// 4
	Mat CreateArrayOnes(int x, int y, double divideBy)
	{
		Mat o = Mat::ones(x, y, CV_32F) / divideBy;
		return o;
	}

	// 5
	Mat CreateArrayZeros(int x, int y, double divideBy)
	{
		Mat z = Mat::zeros(x, y, CV_8UC1) / divideBy;
		return z;
	}
